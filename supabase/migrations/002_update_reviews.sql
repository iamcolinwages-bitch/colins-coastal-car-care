...
INSERT INTO reviews (customer_name, email, rating, review_text, service_type, status) VALUES
  ('Robert Martinez', 'rmartinez@example.com', 5, 'Outstanding service from start to finish! Colin detailed my 2021 Mercedes-Benz E-Class and it looks absolutely stunning. The attention to detail was flawless. Definitely worth the investment!', '2021 Mercedes-Benz E-Class - Premium Combined', 'approved'),
